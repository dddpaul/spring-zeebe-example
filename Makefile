...
# Process with 12 subprocesses with dmn, timer and delay
starter-v6_12:
	@java -jar build/libs/spring-zeebe-example-0.0.1-SNAPSHOT.jar \
	--app.starter.enabled=true \
	--app.starter.process=CarInsuranceApplicationProcessV6_12 \
	--app.starter.threads=$(threads) --app.starter.count=$(count) --app.starter.random=$(random)

# Process with 12 subprocesses with dmn, timer and delay, but 6 is skipped
starter-v6_12_1:
	@java -jar build/libs/spring-zeebe-example-0.0.1-SNAPSHOT.jar \
	--app.starter.enabled=true \
...
# Process with 12 subprocesses with dmn and delay, without end event
starter-v6_12_3:
	@java -jar build/libs/spring-zeebe-example-0.0.1-SNAPSHOT.jar \
	--app.starter.enabled=true \
	--app.starter.process=CarInsuranceApplicationProcessV6_12_3 \
	--app.starter.threads=$(threads) --app.starter.count=$(count) --app.starter.random=$(random)

# Process with 12 jobs with dmn and delay, without subprocess
starter-v6_12_4:
	@java -jar build/libs/spring-zeebe-example-0.0.1-SNAPSHOT.jar \
	--app.starter.enabled=true \
	--app.starter.process=CarInsuranceApplicationProcessV6_12_4 \
	--app.starter.threads=$(threads) --app.starter.count=$(count) --app.starter.random=$(random)

# Process with 12 subprocesses with dmn, timer and delay (+delay to workers)
starter-v6_12_5:
	@java -jar build/libs/spring-zeebe-example-0.0.1-SNAPSHOT.jar \
